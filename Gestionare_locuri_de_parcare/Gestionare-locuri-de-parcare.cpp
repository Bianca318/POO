...
public:
    ...
    void afisare_detalii() {
        cout << "Ora intarii: " << oraintrarii << ", Minutul intarii:" << minutulintrarii << ", Ora iesirii: " << oraiesirii << ", Minutul iesirii:" << minutuliesirii << ", Numar locuri parcare:" << nrlocuriparcare << ", Tarif pe ora:" << calculeazatarif()<<"lei"<<endl;
    }
};
...
public:
    ...
    {
        cout << "Ora intarii: " << oraintrarii  << ", Minutul intarii:" <<minutulintrarii<< ", Ora iesirii: " << oraiesirii << ", Minutul iesirii:" << minutuliesirii << ", Numar locuri parcare:" << nrlocuriparcare << ", Tarif pe ora:" << calculeazatarif() << ", Numar:" << numar;
    }
...
cout << "Afiseaza numarul:";
    ...
    for (i = 0; i < n; i++)
    {
        ...
        cout << "Total tarif:" << masini[i]->calculeazatarif() << "lei" << endl;
    }
